 ...
 * @Last Modified time: 2019-07-30 10:23:15
 */
...
export default {
  ...
  syncGetDevice: function() {
    ...
    const { windowWidth: width, windowHeight: height, model, system, statusBarHeight } = res;
    ...
    console.log(this.isAndroid, this.isIphoneX, model, width, height, 'bbb');
